...
class LoggingExample:
    ...
    def _stab_log_data(self, timestamp, data, logconf):
       ...
       # print(data)
        ...
        threshold = 1.0
        if (abs(ax-self._dataPrev)>threshold and ax>0 and self.dataPrev):
        ...
        if (abs(ax-self._dataPrev)<threshold and ax<0 and self.dataPrev):
            ...
            return
        self._dataPrev = ax
        if (abs(ay-self._dataPrev)>threshold and ay>0 and self.dataPrev):
        ...
        if (abs(ay-self._dataPrev)<threshold and ay<0 and self.dataPrev):
            ...
            return
        self._dataPrev = ay
        if (abs(az-self._dataPrev)>threshold and az>0 and self.dataPrev):
