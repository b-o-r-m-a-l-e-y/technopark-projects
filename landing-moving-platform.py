...
class LoggingExample:
    ...
    def _connected(self, link_uri):
        ...
        self._lg_stab = LogConfig(name='Position', period_in_ms = self.period_in_ms)
    ...
    def _stab_log_data(self, timestamp, data, logconf):
        ...
        self.speedY = (self.posY - self.prevPosY)/self.period_in_ms
        self.nextPosX = self.posX + (self.speedX * self.period_in_ms)
        self.nextPosY = self.posY + (self.speedY * self.period_in_ms)
        self.prevPosX = self.posX
        self.prevPosY = self.posY
        #ax = data['stateEstimate.x']
        #ay = data['stateEstimate.y']
